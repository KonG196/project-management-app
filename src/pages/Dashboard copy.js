...
const handleRegister = () => {
  ...
  return (
    <Box  sx={{minHeight: '100vh', backgroundColor: '#ebe9e1' }}>  
  ...
  <Toolbar sx={{ justifyContent: 'center' }}>
    ...
    <Typography variant="h5" color='#ebe9e1'  sx={{ position: 'absolute', left: '5vh', fontFamily: 'CoFoSans-Bold', fontSize: '32px'}}>
